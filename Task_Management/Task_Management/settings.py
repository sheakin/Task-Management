...
SECRET_KEY = 'django-insecure-dp^y7zllt=0xiyy*$&7l)h-5(q@3f5bc=9&&_*hd^gs@!7qfq^'
...
CORS_ALLOW_ALL_ORIGINS = False  # Ensure this is False, as you want to restrict origins
CORS_ALLOW_CREDENTIALS = True  # Allow credentials like cookies or headers in requests

CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',  # Your React frontend's URL
]

APPEND_SLASH = False  # Optional, if you don't want Django to append a trailing slash
